    ...
    public function main()
    {
        xgo(function () {
            ...
            $sql = "CREATE TABLE IF NOT EXISTS `$table_name` (
                ...
                `wx` float(9,2) DEFAULT NULL,
                `s5_p` float(6,2) DEFAULT NULL,
                `s5_n` float(9,2) DEFAULT NULL,
                `s4_p` float(6,2) DEFAULT NULL,
                `s4_n` float(9,2) DEFAULT NULL,
                `s3_p` float(6,2) DEFAULT NULL,
                `s3_n` float(9,2) DEFAULT NULL,
                `s2_p` float(6,2) DEFAULT NULL,
                `s2_n` float(9,2) DEFAULT NULL,
                `s1_p` float(6,2) DEFAULT NULL,
                `s1_n` float(9,2) DEFAULT NULL,
                `b1_p` float(6,2) DEFAULT NULL,
                `b1_n` float(9,2) DEFAULT NULL,
                `b2_p` float(6,2) DEFAULT NULL,
                `b2_n` float(9,2) DEFAULT NULL,
                `b3_p` float(6,2) DEFAULT NULL,
                `b3_n` float(9,2) DEFAULT NULL,
                `b4_p` float(6,2) DEFAULT NULL,
                `b4_n` float(9,2) DEFAULT NULL,
                `b5_p` float(6,2) DEFAULT NULL,
                `b5_n` float(9,2) DEFAULT NULL,
                `time` time NOT NULL,
